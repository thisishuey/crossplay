...
| [`notes-design.md`](notes-design.md) | Notes: lists you tick with one hand, and why a list is a Markdown file. |
| [`fridge.md`](fridge.md) | Live: a note, drawing or photo sent from a phone to a device asleep on a fridge. |
...
| [`notes-research.md`](notes-research.md) | What people have built for text on small, slow screens, and the Notes design that follows. |
